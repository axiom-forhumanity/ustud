...
- How to use GitHub (clone, pull, commit, push)
- What automation, AI, LLMs, and agents are — and how UStud uses them
- How to record and upload daily trust sessions (screen + webcam)
- How to run UStud locally and work with Cursor

---

## Week 1 calendar

| When | Document | What you do |
|------|----------|-------------|
| **Before Monday** | [01_DAY0_LAPTOP_SETUP.md](01_DAY0_LAPTOP_SETUP.md) | Install software, create accounts |
| **Monday** | [02_GITHUB_ZERO_TO_HERO.md](02_GITHUB_ZERO_TO_HERO.md) + [03_WEEK1_BOOTCAMP.md](03_WEEK1_BOOTCAMP.md) | GitHub basics, first clone and push |
...
| File | Who reads it |
|------|--------------|
| [00_MANAGEMENT_CHECKLIST.md](00_MANAGEMENT_CHECKLIST.md) | Management only (before you start) |
| [01_DAY0_LAPTOP_SETUP.md](01_DAY0_LAPTOP_SETUP.md) | You — laptop setup |
| [02_GITHUB_ZERO_TO_HERO.md](02_GITHUB_ZERO_TO_HERO.md) | You — Git & GitHub commands |
| [03_WEEK1_BOOTCAMP.md](03_WEEK1_BOOTCAMP.md) | You — daily Mon–Fri plan |
| [04_TRUST_RECORDING.md](04_TRUST_RECORDING.md) | You — OBS recording & upload |
| [05_FREE_LEARNING_RESOURCES.md](05_FREE_LEARNING_RESOURCES.md) | You — free courses (NVIDIA, GitHub, Cursor) |
...
1. Add your question to `progress/BLOCKERS.md` and push
2. Contact management using the email or channel they gave you in your welcome message

**Repo:** https://github.com/axiom-forhumanity/ustud
