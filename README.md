...
**New employees:** Start with [cursor/onboarding/README.md](cursor/onboarding/README.md) (zero-to-hero Week 1). Download the printable [Word guide](cursor/onboarding/AXIOM_EMPLOYEE_ONBOARDING.docx). After graduation, use [cursor/EMPLOYEE_ONBOARDING.md](cursor/EMPLOYEE_ONBOARDING.md).
