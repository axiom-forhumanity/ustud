...
**New employees:** Start with [cursor/onboarding/README.md](cursor/onboarding/README.md) (two-week onboarding). Download the printable [Word guide](cursor/onboarding/AXIOM_EMPLOYEE_ONBOARDING.docx). After onboarding, use [cursor/EMPLOYEE_ONBOARDING.md](cursor/EMPLOYEE_ONBOARDING.md).
